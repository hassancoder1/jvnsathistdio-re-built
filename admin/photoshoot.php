<div class="h-auto w-full">
    <h1 class="text-3xl font-bold my-4 text-textPrimary">Photoshoot Images</h1>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <?php
        // Simple MySQLi query
        $query = "SELECT id, name, category, image_path FROM images WHERE location = 'photoshoot' ORDER BY uploaded_at DESC";
